...
export const translations = {
    pt: {
        ...
        // Brand Stories
        'stories.title': 'Histórias de Marca',
        ...
        'stories.desc': 'Marcas não nascem prontas, são forjadas. Uma curadoria de projetos onde a estratégia colide com a estética para criar narrativas visuais que definem o amanhã.',
    ...
    en: {
        ...
        'stories.desc': 'Brands are not born ready, they are forged. A curation of projects where strategy collides with aesthetics to create visual narratives that define tomorrow.',
        'stories.status': 'Status',
